...
export function PolicyForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 max-w-md">
      ...
      <div>
        <label className="block text-sm text-gray-600 dark:text-gray-400 mb-1">Storage Path</label>
        <input
          type="text"
          value={storagePath}
      ...
      <div>
        <label className="block text-sm text-gray-600 dark:text-gray-400 mb-2">Deletion Policy</label>
        ...
        {deletionMode === "days" ? (
          <div>
            <label className="block text-sm text-gray-500 dark:text-gray-500 mb-1">Retain recordings for (days)</label>
            <input
              type="number"
              value={retainDays}
          ...
          <div>
            <label className="block text-sm text-gray-500 dark:text-gray-500 mb-1">Max disk usage (GB)</label>
            <input
              type="number"
              value={maxDiskGb}
